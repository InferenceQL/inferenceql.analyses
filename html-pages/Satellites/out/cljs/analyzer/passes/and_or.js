...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__13116){
var map__13117 = p__13116;
var map__13117__$1 = cljs.core.__destructure_map(map__13117);
var ast = map__13117__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13117__$1,cljs.core.cst$kw$op);
return cljs.core.boolean$((function (){var and__4221__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__4221__auto__){
var G__13119 = (function (){var or__4223__auto__ = cljs.core.cst$kw$tag.cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__13120 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$var,null,cljs.core.cst$kw$local,null], null), null);
return (fexpr__13120.cljs$core$IFn$_invoke$arity$1 ? fexpr__13120.cljs$core$IFn$_invoke$arity$1(op) : fexpr__13120.call(null,op));
})())){
...
var fexpr__13118 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$sym$seq,"null",cljs.core.cst$sym$boolean,"null"], null), null);
return (fexpr__13118.cljs$core$IFn$_invoke$arity$1 ? fexpr__13118.cljs$core$IFn$_invoke$arity$1(G__13119) : fexpr__13118.call(null,G__13119));
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__13121_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(p1__13121_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__13122 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$env,cljs.core.cst$kw$locals], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__13122,local);
} else {
return G__13122;
}
});
...
var map__13123 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__13123__$1 = cljs.core.__destructure_map(map__13123);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13123__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13123__$1,cljs.core.cst$kw$name);
...
var map__13124 = cljs.core.first(cljs.core.cst$kw$bindings.cljs$core$IFn$_invoke$arity$1(ast));
var map__13124__$1 = cljs.core.__destructure_map(map__13124);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13124__$1,cljs.core.cst$kw$init);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13124__$1,cljs.core.cst$kw$name);
