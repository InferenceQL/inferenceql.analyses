...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_6552 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_6552(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_6553 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_6553(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6554 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6554(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6555 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6555(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6556 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6556(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6557 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6557(reader);
}
});
...
var G__6568 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__6569 = s.append(c);
c = G__6568;
s = G__6569;
continue;
}
