...
var periods__$1 = cljs.core.vec((function (){var G__12484 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12483_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__12483_SHARP_,(0),(3));
}),G__12484);
} else {
return G__12484;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__12493){
var vec__12494 = p__12493;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12494,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12494,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,cljs.core.cst$kw$token)){
var G__12497 = pattern;
switch (G__12497) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12497)].join('')));
...
return p1__12499_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__12500_SHARP_){
return p1__12500_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__12501_SHARP_){
return p1__12501_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__12502_SHARP_){
return p1__12502_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__12503_SHARP_){
return p1__12503_SHARP_.getHours();
});

break;
case "day":
return (function (p1__12504_SHARP_){
return p1__12504_SHARP_.getDate();
});

break;
case "month":
return (function (p1__12505_SHARP_){
return p1__12505_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__12506_SHARP_){
return p1__12506_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12507__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__12509){
var vec__12510 = p__12509;
var seq__12511 = cljs.core.seq(vec__12510);
var first__12512 = cljs.core.first(seq__12511);
var seq__12511__$1 = cljs.core.next(seq__12511);
var key = first__12512;
var args = seq__12511__$1;
var G__12513 = key;
...
break;
case "ordinal-suffix":
var vec__12514 = (function (){var G__12517 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__12517) : syntax_list.call(null,G__12517));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12513__$1)].join('')));
...
var d = value;
var G__12522 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__12523 = G__12522;
...
var s = "";
var d__$1 = d;
var G__12522__$1 = G__12522;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__12532 = G__12522__$1;
var seq__12533 = cljs.core.seq(vec__12532);
var first__12534 = cljs.core.first(seq__12533);
var seq__12533__$1 = cljs.core.next(seq__12533);
var unparser__$1 = first__12534;
var more__$1 = seq__12533__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__12535 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12535,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12535,(1),null);
var G__12538 = d__$3;
var G__12539 = more__$1;
var G__12540 = s__$3;
d__$1 = G__12538;
G__12522__$1 = G__12539;
s__$1 = G__12540;
continue;
}
break;
